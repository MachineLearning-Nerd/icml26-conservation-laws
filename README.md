...
| [Cumulative release candidate](https://github.com/MachineLearning-Nerd/icml26-repro-ay4Q69fAJL-conservation-laws-for-modern-neural-architectures/tree/orx/evaluator-visible-cumulative-release-candidate) | Full regression and evaluator-visible package | `uv run --frozen --no-dev python -m conservation_repro.run` | Awaiting final formal run | HF cpu-upgrade |
