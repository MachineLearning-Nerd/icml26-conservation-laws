...
| [Runnable Space package](https://github.com/MachineLearning-Nerd/icml26-repro-ay4Q69fAJL-conservation-laws-for-modern-neural-architectures/tree/orx/runnable-space-root-package) | Make the exact fixed command runnable from Space root | `uv run --frozen --no-dev python -m conservation_repro.run` | Final publication gate | HF cpu-upgrade |
