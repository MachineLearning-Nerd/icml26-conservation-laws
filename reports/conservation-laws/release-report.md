...
`orx/runnable-space-root-package` at
`559a8f7d508cf40f25939972d0a50f487a2e9c7d`. The exact Hugging Face
publication revision is `6219f9cc8d0132ab7407b2d31712ec4180c13c67`.
...
The protected old/new subset check, exact 49-file text upload allowlist,
48-file SHA-256 payload manifest (the manifest excludes its own self-hash),
secret scan, blind-review file-open trace, and final Hugging Face revision are
recorded under `space_patch/release/`. The final GitHub remote SHA is confirmed
with `git ls-remote` after the presentation commit.
